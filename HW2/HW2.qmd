...
-   $\mu_4 > \mu_1$\
    *People that drink between 6 and 8 drinks a day have a higher MCV on average than people who have less than 1 drink a day.*

-   $\mu_5 > \mu_1$*\
    People that drink 9 or more drinks a day have a higher MCV on average than people who have less than 1 drink a day.*

-   $\mu_4 > \mu_2$*\
    People that drink between 6 and 8 drinks a day have a higher MCV on average than people who 1 or 2 drinks per day.*

-   $\mu_4 > \mu_3$*\
    People that drink between 6 and 8 drinks a day have a higher MCV on average than people who 3 to 5 drinks per day.*
...
-   $\mu_5 > \mu_2$\
    *People that drink 9 or more drinks a day have a higher Alkphos on average than people who 1 or 2 drinks per day.*

-   $\mu_5 > \mu_3$*\
    People that drink 9 or more drinks a day have a higher Alkphos on average than people who 3 to 5 drinks per day.*
...
-   *There was no significant difference in means in either the MCV or alkphos test where a group that drank [less]{.underline} when compared to a group that drank more. The significant difference always showed a heavier drinking group with a larger mean than the lighter drinkers.*
...
-   *Type 3*
    ...
    -   *Tells us that only sex has a significant difference in mean salary.*
...
# I picked the aov.psych.no_interaction_term as my model because we are primarily concered about the interaction between sex and salary. This is a simpler model because it doesn not include the interaction effect. Simpler is good.
...
-   The results above show us the following:
    ...
    -   $\mu_6 < \mu_4$
        ...
        On average a 6-cylinder car's highway milage is 6.17 mpg worse than a car with 4-cylinders.

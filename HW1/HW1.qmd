...
3.  Since our populations are not normally distributed, the last thing that we need to test is our populations to see whether or not they fall *in the same* distribution.To do this we will perform the *Wilcoxen Rank Test*

...
-   While our model is significant (low p-val) and proves that there is a linear relationship between Cholesterol and Weight, with such a low ${R}^2$, I think that there are better models out there!
